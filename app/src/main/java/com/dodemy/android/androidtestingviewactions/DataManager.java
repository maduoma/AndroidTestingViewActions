package com.dodemy.android.androidtestingviewactions;
...
public class DataManager {
    ...
    public int createNewNote() {
        com.dodemy.android.androidtestingviewactions.NoteInfo note = new com.dodemy.android.androidtestingviewactions.NoteInfo(null, null, null);
        mNotes.add(note);
        return mNotes.size() - 1;
    }

    public int findNote(com.dodemy.android.androidtestingviewactions.NoteInfo note) {
    ...
    public List<com.dodemy.android.androidtestingviewactions.NoteInfo> getNotes(CourseInfo course) {
        ArrayList<com.dodemy.android.androidtestingviewactions.NoteInfo> notes = new ArrayList<>();
        for(com.dodemy.android.androidtestingviewactions.NoteInfo note:mNotes) {
    ...
    public void initializeExampleNotes() {
        ...
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Dynamic intent resolution",
                "Wow, intents allow components to be resolved at runtime"));
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Delegating intents",
        ...
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Service default threads",
                "Did you know that by default an Android Service will tie up the UI thread?"));
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Long running operations",
        ...
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Parameters",
                "Leverage variable-length parameter lists"));
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Anonymous classes",
        ...
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Compiler options",
                "The -jar option isn't compatible with with the -cp option"));
        mNotes.add(new com.dodemy.android.androidtestingviewactions.NoteInfo(course, "Serialization",
    ...
    public int createNewNote(CourseInfo course, String noteTitle, String noteText) {
        ...
        com.dodemy.android.androidtestingviewactions.NoteInfo note = getNotes().get(index);
